    ...
    <>
      ...
      >
        <div className="mx-auto flex h-18 max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/register"
              className="hidden h-9 items-center rounded-lg px-5 text-sm font-semibold transition-all duration-200 hover:scale-[1.02] hover:shadow-lg md:inline-flex"
              style={{
                background: "oklch(0.78 0.16 55)",
                color: "oklch(0.08 0 0)",
                boxShadow: "0 0 20px oklch(0.78 0.16 55 / 0.3)",
              }}
            >
              Daftar
            </Link>
      ...
      >
        <nav className="flex h-full flex-col items-center justify-center gap-8">
          ...
          <Link
            href="/register"
            className="mt-2 inline-flex h-12 items-center rounded-xl px-8 text-base font-semibold transition-all duration-200"
            style={{
              background: "oklch(0.78 0.16 55)",
              color: "oklch(0.08 0 0)",
