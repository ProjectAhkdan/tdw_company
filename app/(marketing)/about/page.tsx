...
import { getCompanyStats, getTeamMembers, getMediaCoverage } from "@/lib/supabase/queries"
...
const FALLBACK_STATS = [
  ...
  { id: "3", label: "Tahun", value: "20+", sort_order: 2 },
  { id: "4", label: "Kota", value: "25+", sort_order: 3 },
]
const FALLBACK_MEDIA = [
  { id: "1", name: "Kompas", logo_url: null, sort_order: 0 },
  { id: "2", name: "Metro TV", logo_url: null, sort_order: 1 },
  { id: "3", name: "Trans TV", logo_url: null, sort_order: 2 },
  { id: "4", name: "CNN Indonesia", logo_url: null, sort_order: 3 },
  { id: "5", name: "Forbes Indonesia", logo_url: null, sort_order: 4 },
  { id: "6", name: "Bisnis Indonesia", logo_url: null, sort_order: 5 },
]
      ...
      <section className="relative overflow-hidden py-32 px-6 text-center">
        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
            Perusahaan pelatihan dan pengembangan diri terbesar di Indonesia yang telah mengubah ratusan ribu kehidupan selama lebih dari dua dekade.
          </p>
        </div>
      </section>
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            <div className="relative mx-auto w-full max-w-sm lg:mx-0">
              ...
              <div className="relative glass rounded-3xl p-10 text-center"
                ...
                <p className="mt-1 text-sm text-muted-foreground">Motivator & Business Coach #1 Indonesia</p>
                <div className="mt-6 divider-gold" />
                <div className="mt-6 grid grid-cols-2 gap-4 text-center">
                  <div>
                    <p className="text-2xl font-bold" style={{ color: GOLD }}>50K+</p>
                    <p className="text-xs text-muted-foreground">Alumni</p>
                  </div>
                  <div>
                    <p className="text-2xl font-bold" style={{ color: GOLD }}>20+</p>
            ...
            <div className="space-y-5">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Tung Desem Waringin adalah seorang motivator, pembicara publik, dan pelatih bisnis nomor satu di Indonesia. Beliau telah menginspirasi lebih dari 50.000 orang melalui seminar-seminar yang diselenggarakan di berbagai kota besar di Indonesia selama lebih dari dua dekade.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Dengan latar belakang di bidang keuangan dan properti, TDW telah membantu ribuan pengusaha meningkatkan omzet bisnis mereka secara signifikan. Metode <em className="text-foreground">Financial Revolution</em> dan <em className="text-foreground">Life Revolution</em> yang diciptakannya telah menjadi program pelatihan paling diminati di Asia Tenggara.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Sebagai penulis buku best-seller <em className="text-foreground">&quot;Financial Revolution&quot;</em> dan <em className="text-foreground">&quot;Marketing Revolution&quot;</em>, TDW terus berkomitmen untuk membagikan ilmu dan pengalaman kepada masyarakat Indonesia.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="glass rounded-2xl p-8" style={{ border: `1px solid ${GOLD}25` }}>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Menjadi perusahaan pelatihan dan pengembangan diri terdepan di Asia Tenggara yang menghasilkan individu-individu berkualitas, berdaya saing tinggi, dan mampu memberikan dampak positif bagi masyarakat.
              </p>
            </div>
            <div className="glass rounded-2xl p-8" style={{ border: `1px solid ${GOLD}25` }}>
              <div className="mb-4 text-sm font-bold uppercase tracking-widest" style={{ color: GOLD }}>Misi</div>
              <h3 className="mb-3 text-xl font-bold" style={{ fontFamily: "'Playfair Display', serif" }}>
                Memberdayakan Setiap Peserta
              </h3>
              <p className="text-muted-foreground leading-relaxed">
                Menyediakan program pelatihan berkualitas tinggi yang terjangkau, membangun komunitas pembelajar yang saling mendukung, dan menciptakan ekosistem bisnis yang memberdayakan seluruh peserta untuk mencapai potensi terbaik mereka.
              </p>
            </div>
          </div>
        </div>
