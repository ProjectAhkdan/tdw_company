...
import { registerAffiliate, requestWithdrawal } from "@/server/actions/affiliate"

const GOLD = "oklch(0.78 0.16 55)"

type Stats = Awaited<ReturnType<typeof import("@/server/actions/affiliate").getAffiliateStats>>
