  ...
  return (
    <>
      <header
        ...
        style={{
          background: scrolled ? "oklch(0.07 0.005 260 / 0.85)" : "transparent",
        ...
        <div className="mx-auto flex h-18 max-w-7xl items-center justify-between px-6 py-4">
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  style={{ color: active ? "oklch(0.78 0.16 55)" : "oklch(0.65 0.01 60)" }}
                  onMouseEnter={(e) => { if (!active) (e.currentTarget as HTMLElement).style.color = "oklch(0.96 0.005 60)" }}
                  onMouseLeave={(e) => { if (!active) (e.currentTarget as HTMLElement).style.color = "oklch(0.65 0.01 60)" }}
                >
                  {link.label}
                </Link>
              )
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              style={{ color: "oklch(0.65 0.01 60)", border: "1px solid oklch(0.22 0.01 55 / 0.5)" }}
            ...
            <Link href="/register" className="hidden md:inline-flex">
              <PillButton pillColor="oklch(0.78 0.16 55)" textColor="oklch(0.08 0 0)" hoverCircleColor="#120F17" hoverTextColor="oklch(0.78 0.16 55)">
                {t('nav.register')}
              </PillButton>
            </Link>
            <button
              ...
              style={{ background: "oklch(0.14 0.01 55)", color: "oklch(0.78 0.16 55)" }}
