...
const vec3 ORANGE_LIGHT = vec3(255.0, 120.0, 0.0) / 255.0;
const vec3 ORANGE_DARK  = vec3(120.0, 40.0, 0.0) / 255.0;
...
vec3 background_color(vec2 uv) {
  ...
  col += mix(ORANGE_DARK, BLACK, smoothstep(0.0, 1.0, abs(m)));
  col += mix(ORANGE_LIGHT, BLACK, smoothstep(0.0, 1.0, abs(m - 0.8)));
  return col * 0.5;
}
