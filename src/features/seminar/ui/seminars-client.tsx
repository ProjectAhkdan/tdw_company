      ...
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        {filtered.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <PillButton onClick={() => { setSearch(""); setCategoryId("all"); setSort("newest") }}
              className="mt-6" pillColor={GOLD} textColor="oklch(0.08 0 0)" hoverCircleColor="#120F17" hoverTextColor={GOLD}>
              Reset Filter
            </PillButton>
          </div>
        ) : (
